...
SECRET_KEY = 'django-insecure-!69=m2tk6&io_ce6loc1$t1ee=r&%14qc2zpgctsjol4qi=g%y'
...
MIDDLEWARE = [
    ...
    'utils.middleware.ValidarLicenciaMiddleware', #middleware de validación de licencia
]
